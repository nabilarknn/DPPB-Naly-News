...
class TrendingCeleb extends StatefulWidget {
  @override
  _TrendingCelebState createState() => _TrendingCelebState();
}

class _TrendingCelebState extends State<TrendingCeleb> {
  List _posts = [];
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          'https://newsapi.org/v2/top-headlines?q=celeb&apiKey=6e0a5835c2734deca7a6d3caa27668f2'));
