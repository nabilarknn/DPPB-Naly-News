...
class TrendingApple extends StatefulWidget {
  @override
  _TrendingAppleState createState() => _TrendingAppleState();
}

class _TrendingAppleState extends State<TrendingApple> {
  List _posts = [];
  ...
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          'https://newsapi.org/v2/everything?q=apple&from=2023-06-09&to=2023-06-09&sortBy=popularity&apiKey=0a12db1bdab74312852773017facb04c'));
